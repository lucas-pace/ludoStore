                                   ...
                                   <?php $consultatabela= "SELECT id_categoria FROM categoria ";
                                    ...
                                    if ($resultadotab->fetch_assoc() != NULL){ 
                                        while ($row = $result->fetch_assoc()){ ?>
                                            ...
                                            <tr> 
                                                <td>
                                                    <a class="hiperlinkProductTable" href="tabelacategoriaindividual.php?categoria=<?php echo $row['id_categoria']; ?>" ><?php echo $row['nome_categoria'];?></a>
                                                    </td>
                                                <td>
...
<?php include 'footer-ADM.php';?>  
>>>>>>> 2d32dfc53a2f8d312e3beaa1cc8d54506fac5734
