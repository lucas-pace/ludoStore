    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 filter infantil">
          <a href="#"><img src="../fotoscontent_ajm001_3d-box_400px.png" class="img-fluid"></a>
        ...
        <div class="col-md-4 filter infantil">
          <a href="#"><img src="../fotoscontent_kro101_3d-box_400px.jpg" class="img-fluid"></a>
          <figcaption class="figure-caption bg-light text-center">Arena</figcaption>
          <figcaption class="figure-caption bg-light text-center">R$20,00</figcaption>
        </div>
        <div class="col-md-4 filter infantil">
          <a href="#"><img src="../fotoscontent_tak001_3d-box_400px.png" class="img-fluid" alt="Takenoko"></a>
          <figcaption class="figure-caption bg-light text-center">Takenoko</figcaption>
          <figcaption class="figure-caption bg-light text-center">R$20,00</figcaption>
        </div>
        <div class="col-md-4 filter adulto">
          <a href="#"><img src="../fotoscontent_blb001_3d-box_400px.png" class="img-fluid"></a>
          <figcaption class="figure-caption bg-light text-center">Bloodborne</figcaption>
          <figcaption class="figure-caption bg-light text-center">R$20,00</figcaption>
        </div>
        <div class="col-md-4 filter adulto">
          <a href="#"><img src="../fotoscontent_jogo-de-tabuleiro-a-guerra-dos-tronos-board-game-caixa.png" class="img-fluid"></a>
          <figcaption class="figure-caption bg-light text-center">Game of Thrones</figcaption>
          <figcaption class="figure-caption bg-light text-center">R$20,00</figcaption>
        </div>
        <div class="col-md-4 filter adulto">
          <a href="#"><img src="../fotoscontent_dow002_3d-box_400px.jpg" class="img-fluid"></a>
