...
<body>
  ...
  <br>
  <div class="galeria">
    <h1 class="titulo">Jogos de Tabuleiros</h1>
  </div>
  <div class="container">
    <div class="row" >     
  ...
  <div class="row mb-5">
        <div class="card-columns">
                <div class="card filter infantil" style="width: 20rem;">
                        <img class="card-img-top img-200-200" src="../fotosbichos.jpg" alt="Card image cap">
                            <div class="card-body">
                ...
                <div class="card filter infantil" style="width: 20rem;">
                        <img class="card-img-top img-200-200" src="../fotosmario.jpg" alt="Card image cap">
                            <div class="card-body">
                ...
                <div class="card filter infantil" style="width: 20rem;">
                        <img class="card-img-top img-200-200" src="../fotosmoveis.jpg" alt="Card image cap">
                            <div class="card-body">
                ...
                <div class="card filter adulto" style="width: 20rem;">
                        <img class="card-img-top img-200-200" src="../fotosguerra civil.jpg" alt="Card image cap">
                            <div class="card-body">
                ...
                <div class="card filter adulto" style="width: 20rem;">
                        <img class="card-img-top img-200-200" src="../fotosharry.jpg" alt="Card image cap">
                            <div class="card-body">
                ...
                <div class="card filter adulto" style="width: 20rem;">
                        <img class="card-img-top img-200-200" src="../fotosaneis.jpg" alt="Card image cap">
                            <div class="card-body">
